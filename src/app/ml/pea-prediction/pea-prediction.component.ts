...
@Component({
  selector: 'app-pea-prediction',
  templateUrl: './pea-prediction.component.html',
  styleUrls: ['./pea-prediction.component.scss']
})
export class PeaPredictionComponent implements OnInit {
